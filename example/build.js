...
/***/ function(module, exports, __webpack_require__) {
	...
	var _twemoji = __webpack_require__(159);
	  ...
	  _createClass(Face, [{
	    ...
	    value: function render() {
	      ...
	      if (this.props.isActive || this.props.willBeActive) {
	        return _react2.default.createElement('span', { dangerouslySetInnerHTML: { __html: _twemoji2.default.parse(icons[this.props.icon]) } });
	      } else {
	        return _react2.default.createElement('span', { dangerouslySetInnerHTML: { __html: _twemoji2.default.parse('😑') } });
	      }
	    }
	  }]);
	...
	var Example = function (_Component2) {
	  ...
	  function Example(props) {
	    ...
	    var _this2 = _possibleConstructorReturn(this, Object.getPrototypeOf(Example).call(this, props));
	  ...
	  _createClass(Example, [{
	    key: 'handleRate',
	    value: function handleRate(rating, lastRating) {
	      this.setState({
	        rating: rating
	      });
	      ...
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          ...
	          _react2.default.createElement(
	            'dt',
	            null,
	            'Limit maximum rating by setting ',
	            _react2.default.createElement(
	              'code',
	              null,
	              'limit'
	          ...
	          _react2.default.createElement(
	            'dt',
	            null,
	            'Retrieve rating value by setting a callback on ',
	            _react2.default.createElement(
	              'code',
	              null,
	              'onRate'
	          ...
	          _react2.default.createElement(
	            ...
	            _react2.default.createElement(_src2.default, { rating: this.state.rating, onRate: this.handleRate.bind(this) }),
	            _react2.default.createElement(
	              'span',
	              null,
	          ...
	          _react2.default.createElement(
	            ...
	            _react2.default.createElement(
	              _src2.default,
	              { total: 3, className: 'face-rater' },
	              _react2.default.createElement(Face, { icon: 'bad' }),
	              _react2.default.createElement(Face, { icon: 'normal' }),
	              _react2.default.createElement(Face, { icon: 'good' })
	            )
	          )
	        )
	      );
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _star = __webpack_require__(161);
	  ...
	  _createClass(Rater, [{
	    ...
	    value: function render() {
	      ...
	      nodes = Array(total).join(',').split(',').map(function (_, i) {
	        var starProps = {
	          isActive: !_this2.state.isRating && i < rating,
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Star = function (_Component) {
	  ...
	  _createClass(Star, [{
	    key: 'render',
	    value: function render() {
	      var starClasses = (0, _classnames2.default)('star', {
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		...
		if(!content.locals) {
			module.hot.accept("!!./../node_modules/css-loader/index.js!./../node_modules/sass-loader/index.js!./react-rater.scss", function() {
				var newContent = require("!!./../node_modules/css-loader/index.js!./../node_modules/sass-loader/index.js!./react-rater.scss");
